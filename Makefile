...
obj=main.o Parameter.o JC_Parameter.o OP.o 
#Sub.o QWave.o Super.o DMRGP.o Corr.o
main:$(obj)
...
JC_Parameter.o:JC_Parameter.h JC_Parameter.cpp
	$(CCCOM) -c JC_Parameter.cpp -O2 $(LIBSPECTRA)
OP.o:OP.h OP.cpp
